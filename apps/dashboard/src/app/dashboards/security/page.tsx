...
/**
 * SecurityPage Route Page
 * Memory Boundary Access & Secrets Scanner Dashboard
 */
    ...
    <div className="min-h-screen bg-[#060608] text-zinc-100 font-sans p-8 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <div className="border-b border-zinc-900 pb-4">
          <h1 className="text-2xl font-bold tracking-wide text-zinc-100">SECURITY SYSTEM</h1>
          <p className="text-xs text-[#ff6d5a] mt-1 font-semibold uppercase tracking-wider">Memory Boundary Access & Secrets Scanner Dashboard</p>
        </div>
